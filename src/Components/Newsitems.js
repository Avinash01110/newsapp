  ...
  render() {
    ...
    return (
        ...
        <div className='flex-column mt-3'>
            ...
            <span className=" h-auto py-2 px-4 shadow-md no-underline rounded-full bg-red-700 text-white font-sans font-semibold text-sm border-red hover:text-white hover:bg-red-light focus:outline-none active:shadow-none">{source}</span>	
            </div>
        <div className="border border-[#DDDDDD] h-auto w-80 bg-white rounded-lg flex-row content-between">
            ...
            <a href={newsurl}>
              <button className="relative group overflow-hidden px-6 h-12 rounded-full flex space-x-2 items-center bg-[#301E67] hover:bg-[#472183]">
